...
This document notes the main quirks of the C0 language. Some parts are quoted explicitly from the
original C0/C1 reference. We will also note the intentional design branches from the original C0/C1 languages here.
